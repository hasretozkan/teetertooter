import { MAX_ITEM_WEIGHT, HORIZONTAL_CELLS_COUNT, SCALE_AMOUNT, BASE_SCALE, CELL_UNIT_SIZE } from './constants';
...
export const reverseHorizontalCellPosition = (maxCount: number, currentPosition: number): number => {
